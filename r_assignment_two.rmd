...
The estimated risk difference is `r stdized.rd` (95% confidence interval: (`r round(ci.rd.bca$bca[4], 2)`, `r round(ci.rd.bca$bca[5], 2)`).

The estimated risk ratio is `r stdized.rr` (95% confidence interval: (`r round(ci.rr.bca$bca[4], 2)`, `r round(ci.rr.bca$bca[5], 2)`).
